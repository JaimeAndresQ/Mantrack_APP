...
class WidgetMethod2_2 extends StatefulWidget {
  final int ultimos_n_dias;

  const WidgetMethod2_2({super.key, required this.ultimos_n_dias});

  @override
  State<WidgetMethod2_2> createState() => _WidgetMethod2_2State();
}

class _WidgetMethod2_2State extends State<WidgetMethod2_2> {
  List<ChartData> chartData = [];
  List<Color> colores = [];
...
class WidgetMethod2_3 extends StatefulWidget {
  final int ultimos_n_dias;

  const WidgetMethod2_3({super.key, required this.ultimos_n_dias});

  @override
  State<WidgetMethod2_3> createState() => _WidgetMethod2_3State();
}

class _WidgetMethod2_3State extends State<WidgetMethod2_3> {
  List<ChartData> chartData = [];
  List<Color> colores = [];
...
class WidgetMethod2_4 extends StatefulWidget {
  final int ultimos_n_dias;

  const WidgetMethod2_4({super.key, required this.ultimos_n_dias});

  @override
  State<WidgetMethod2_4> createState() => _WidgetMethod2_4State();
}

class _WidgetMethod2_4State extends State<WidgetMethod2_4> {
  List<ChartData> chartData = [];
  List<Color> colores = [];
