  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: (){
        ...
        selectedIndexProvider.updateSelectedOrdenTrabajo(ordenData);
      },
      child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  SizedBox(
                      child: Avatar(
                    name: "${ordenData.usuario.persona.nombres} ${ordenData.usuario.persona.apellidos}",
                    shape: AvatarShape(
                        width: 40,
                        height: 40,
                ...
                Text(
                  "Creado por ${ordenData.usuario.persona.nombres} ${ordenData.usuario.persona.apellidos}",
                  style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w500,
